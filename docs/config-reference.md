...
| `trusted_bot_ids_url` | string \| omit | omitted | HTTPS endpoint returning a newline-delimited bot ID registry. Entries merge with static/file IDs. Fetch, HTTP, size, UTF-8, empty, or ID validation failure stops startup. |
